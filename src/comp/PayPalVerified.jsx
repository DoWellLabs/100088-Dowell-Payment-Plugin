...
const PayPalVerified = () => {
  ...
  return (
    <div className="home-container">
      <h2 className="h">PayPal  Verification</h2>
      <label>
        Price:
        <input
          type="number"
      ...
      <button className="button" onClick={handleSubmit}>verified Payment</button>
      {approvalUrl && (
        <div>
          <p>Approval URL:</p>
